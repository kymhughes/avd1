...
$osOptURL = 'https://stgenitmnpd001.blob.core.windows.net/data/Windows_10_VDI_Optimize-main.zip'
...
# instrumentation
$osOptURL = 'https://stgenitmnpd001.blob.core.windows.net/data/Windows_VDOT.ps1'
